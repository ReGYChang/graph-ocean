...
public interface GraphMapper {
    ...
    Map<Class<?>, List<Object>> executeQuerySql(String sql, List<Class<?>> classList) throws NebulaException, IllegalAccessException, InstantiationException, UnsupportedEncodingException, ClientServerIncompatibleException, AuthFailedException, NotValidConnectionException, IOErrorException;
    ...
    Map<Class<?>, List<Object>> executeQuery(GraphQuery query, List<Class<?>> classList) throws NebulaException, IllegalAccessException, InstantiationException, UnsupportedEncodingException, ClientServerIncompatibleException, AuthFailedException, NotValidConnectionException, IOErrorException;
     ...
     * @return 顶点列表
     */
    <T> List<T> fetchVertexTag(Class<T> vertexClazz, String... vertexIds) throws UnsupportedEncodingException, IllegalAccessException, InstantiationException, ClientServerIncompatibleException, AuthFailedException, NotValidConnectionException, IOErrorException;

    Map<Class<?>, List<Object>> fetchVertexTags(List<Class<?>> classList, String... vertexIds) throws UnsupportedEncodingException, IllegalAccessException, InstantiationException, ClientServerIncompatibleException, AuthFailedException, NotValidConnectionException, IOErrorException;
}
